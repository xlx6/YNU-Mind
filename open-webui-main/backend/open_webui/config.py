...
DEFAULT_CONFIG = {
    ...
    {
        "title": ["考试复习助手", "生成模拟试题"],
        "content": "帮我生成一份《高等数学（二）》课程的期末模拟试题，包含选择题和简答题。"
    },
    {
        "title": ["校园导览", "查询地点路线"],
        "content": "从文渊楼到图书馆的步行路线怎么走？请告诉我沿途的标志性建筑。"
    },
    {
        "title": ["奖学金申请", "流程与条件查询"],
        "content": "申请国家奖学金需要满足哪些条件？具体的申请步骤是什么？"
    },
    {
        "title": ["课程安排", "查看学期课表"],
        "content": "帮我查询软件工程专业大三下学期的核心课程安排表"
    },
    {
        "title": ["校园服务", "校车时刻查询"],
        "content": "呈贡校区到东陆园区的校车本周运行时刻表是怎样的？"
    },
    {
        "title": ["学术资源", "论文写作指导"],
        "content": "请提供人文社科类毕业论文的写作规范模板和查重注意事项"
    },
    {
        "title": ["生活服务", "宿舍报修流程"],
        "content": "宿舍空调出现故障，应该如何进行线上报修？"
    },
    {
        "title": ["校园活动", "近期讲座推荐"],
        "content": "推荐本周值得参加的学术讲座或文化活动"
    },
    {
        "title": ["入学指南", "新生必备清单"],
        "content": "请列出大一新生入学需要准备的证件和物品清单"
    },
    {
        "title": ["就业指导", "实习信息查询"],
        "content": "如何通过学校就业服务平台查找本地企业实习机会？"
    },
    {
        "title": ["图书馆服务", "借阅规则说明"],
        "content": "研究生最多可以同时借阅多少本专业书籍？续借如何操作？"
    },
    {
        "title": ["教务管理", "成绩单申请"],
        "content": "中英文对照的正式成绩单应该去哪里申请？需要准备哪些材料？"
    }
        ],
    },
}
